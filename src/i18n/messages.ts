...
export const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    "admin.pagination.totalWithPages": "{total} total - {totalPages} pages",
    "admin.pagination.pageItems": "{count} on this page",
  ...
  vi: {
    ...
    "admin.pagination.totalWithPages": "{total} tổng - {totalPages} trang",
    "admin.pagination.pageItems": "{count} mục trên trang này",
